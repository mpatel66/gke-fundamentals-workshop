...
Note that the flag `--workload-pool=<PROJECT_ID>.svc.id.goog` enables the Workload Identity feature. This feature allows workloads in GKE clusters to impersonate IAM service accounts.
