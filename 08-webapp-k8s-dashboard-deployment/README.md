...
Paste the token into the login page. It might take a while for this to work.

Once signed in, you change the namespace in the dropdown at the top of the page.
